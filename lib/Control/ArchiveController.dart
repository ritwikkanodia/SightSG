...
class ArchiveController {
  ...
  static Future uploadPicture(File image) async { // Function needs image parameter, or move function to where the image is being clicked and stored
    StorageReference firebaseStorageRef = FirebaseStorage.instance.ref().child("${userProfile.getUserID()}/${path.basename(image.path)}");
    ...
    DatabaseController dc = new DatabaseController(uid: userProfile.getUserID());
